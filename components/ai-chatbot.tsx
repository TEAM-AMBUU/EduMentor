...
const AIChatbot: React.FC = () => {
    ...
    initialMessages: [
      {
        id: "welcome",
        role: "assistant",
        content: "Hello! I'm your mentoring assistant. Where would you like to explore today?",
      },
    ],
    onError: (error) => {
  ...
  return (
    <div className="flex flex-col h-[400px] border rounded-md">
      <ScrollArea ref={scrollAreaRef} className="flex-grow p-4" onWheel={() => setAutoScroll(false)}>
        {error && (
