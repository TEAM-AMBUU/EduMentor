                ...
                <TabsContent value="lessons">
                  <ul className="space-y-2">
                    {lessons.map((lesson) => (
                      <li
                        key={lesson.id}
                        className={`p-2 rounded cursor-pointer ${activeLesson === lesson.id ? "bg-muted" : ""}`}
                  ...
                  <ul className="space-y-2">
                    <li>
                      <Button variant="outline" className="w-full justify-start">
                        <Download className="mr-2 h-4 w-4" /> React Cheat Sheet.pdf
                      </Button>
                    </li>
                    <li>
                      <Button variant="outline" className="w-full justify-start">
        ...
        <div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Test your knowledge after each lesson</CardDescription>
            </CardHeader>
            <CardContent>
