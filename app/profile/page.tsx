...
export default function ProfilePage() {
  ...
  const achievements = [
    { id: 1, title: "Course Completion Master", description: "Completed 5 courses", icon: GraduationCap },
    { id: 2, title: "Quiz Whiz", description: "Scored 100% on 10 quizzes", icon: Award },
    { id: 3, title: "Consistent Learner", description: "Logged in for 30 consecutive days", icon: BookOpen },
  ]
  ...
  const savedNotes = [
    { id: 1, title: "React Hooks Overview", course: "Advanced React Techniques" },
