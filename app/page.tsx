  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="text-center py-20 bg-gradient-to-r from-primary to-secondary text-primary-foreground rounded-lg mb-12">
        <h1 className="text-4xl md:text-6xl font-bold mb-4">Welcome to EduMentor</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[1, 2, 3].map((i) => (
            <Card key={i}>
              ...
              <CardContent>
                <p className="mb-4">
                  EduMentor has transformed the way I learn. The personalized approach and AI-powered recommendations
                  have helped me achieve my goals faster.
                </p>
